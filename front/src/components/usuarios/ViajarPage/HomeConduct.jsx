...
const SolicitudesViaje = () => {
  ...
  const viajes = [
    { id: 1, pasajero: "Juan Perez", patente: "ABC123", monto: 50.0 },
    { id: 2, pasajero: "Maria Rodriguez", patente: "XYZ789", monto: 35.0 },
        ...
        {viajes.map((viaje) => (
          <div key={viaje.id} className="col-12">
            <div className="card">
              ...
              <div className="col-12">
                <button className="btn btn-b btn-danger w-100" disabled>
                  Aceptar viaje
                </button>
              </div>
            </div>
