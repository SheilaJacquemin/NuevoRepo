...
function FormLogin() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch('http://localhost:3000/api/users/login', opciones);
  ...
  return (
    <form onSubmit={handleSubmit} className="text-white form-home" encType="multipart/form-data">
